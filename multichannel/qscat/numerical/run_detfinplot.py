...
vals = kmat.getFinDetRealRange(args.plotStart_, args.plotEnd_, args.plotComplex_, args.steps_)
dvals = kmat.getDiffFinDetRealRange(args.plotStart_, args.plotEnd_, args.plotComplex_, args.steps_)
