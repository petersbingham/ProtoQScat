...
vals = kmat.getFinDetImagRange(args.plotStart_, args.plotEnd_, args.offset_, args.steps_)
dvals = kmat.getDiffFinDetImagRange(args.plotStart_, args.plotEnd_, args.offset_, args.steps_)
