...
cd ../../..
python -u ../qscat/numerical/polecalculatorwrap.py $SET_START $SET_END $SET_OFFSET 11 $CF_STEPS $START_DIST_THRES $AMALG_THRES $ZERO_VALUE_EXPONENT $N_MIN $N_MAX $FLAG_RMATRIX_POLES_INDEX > out_rat.dat
